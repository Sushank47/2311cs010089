...
- The heap elements are ordered by their priority value (calculated from their category weight and timestamp).
...
- This yields a performance complexity of $O(1)$ per incoming real-time alert, ensuring sub-microsecond processing overhead.
